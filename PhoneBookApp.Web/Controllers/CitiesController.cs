...
namespace PhoneBookApp.Web.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(PhoneBookAppContext context)
        {
            _context = context;
        }
        ...
        {
            var phoneBookAppContext = _context.Cities.Include(c => c.Country);
        ...
        // Returns list of cities for passed country parameter
